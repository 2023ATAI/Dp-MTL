...
def get_args() -> dict:
    ...
    # path
    parser.add_argument('--inputs_path', type=str, default=r'D:\nm\lg\MTAN\HB-MTL')
    parser.add_argument('--nc_data_path', type=str, default='D:\LG\data')
    ...
    # CrossStitchNet
    parser.add_argument('--label',nargs='+', type=str, default=["volumetric_soil_water_layer_1","volumetric_soil_water_layer_2","volumetric_soil_water_layer_3","total_evaporation"])
    ...
    parser.add_argument('--land_surface_list', nargs='+', type=str, default=["surface_solar_radiation_downwards_w_m2","surface_thermal_radiation_downwards_w_m2","soil_temperature_level_2","total_runoff"])
          # static SM: ["soil_water_capacity"]
          # static SSHF: ["soil_water_capacity"]
    parser.add_argument('--static_list', nargs='+', type=str, default=["soil_water_capacity","landtype","clay_0-5cm_mean","sand_0-5cm_mean","silt_0-5cm_mean"])
